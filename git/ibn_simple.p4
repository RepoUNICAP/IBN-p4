 ...
 *        limite[1]        : quantos SYNs (em 10 s) um host pode mandar (0 = desligado)
 *        syn_count[1024]  : quantos SYNs cada host mandou na janela atual
 *        bloqueado[1024]  : 1 = flagrado; fica assim ate "liberar" ou a duracao vencer
 *        duracao[1]       : 0 = indefinido, senao tempo de bloqueio em microssegundos
